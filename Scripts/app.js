...
//Contact Section form data stored in variables
      ...
      console.log("Hi, My First Name is: ", firstName.value);
      ...
      document.getElementById('contactForm').addEventListener('submit', function (e){
      e.preventDefault();
      console.log("My Last Name is: ",lastName.value);
});     
      //Contact Number
      let contactNumber=document.getElementById('contactNumber');
      document.getElementById('contactForm').addEventListener('submit', function (e){
      e.preventDefault();
      console.log("My Contact Number is: ",contactNumber.value); 
});     
      // Email
      let email=document.getElementById('email');
      document.getElementById('contactForm').addEventListener('submit', function (e){
      e.preventDefault();
      console.log("My Email Address is: ",email.value);
});
      // Short Message Here
      let shortMessage=document.getElementById('yourMessage');
      document.getElementById('contactForm').addEventListener('submit', function (e){
      e.preventDefault();
      console.log("My Additional Information is: ",shortMessage.value);
});
